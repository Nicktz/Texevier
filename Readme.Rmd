...
After installing all three at the top, simply run the following code __(NOTE - if you experience issue when installing, set ShowPDFatLaunch to FALSE and investigate the Rmd file directly.)__:
